...
{
    public partial class CreateDatabaseLoyaltyDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomersStores", x => new { x.CustomerId, x.StoreId });
                    table.ForeignKey(
                        name: "FK_CustomersStores_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomersStores_Stores_StoreId",
                        column: x => x.StoreId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomersStores_StoreId",
